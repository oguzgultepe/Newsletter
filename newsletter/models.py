...
class Submission(models.Model):
    title_german = models.CharField("German Title", max_length=100)
    title_english = models.CharField("English Title", max_length=100)
    text_german = models.TextField("German Text", max_length=1000)
    text_english = models.TextField("English Text", max_length=1000)
    author = models.ForeignKey(User, editable=False)
    category = models.ForeignKey(Category)
    link_german = models.URLField("German Link")
    link_english = models.URLField("English Link")
